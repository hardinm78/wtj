...
class Lakeland:SKScene, SKPhysicsContactDelegate {
    ...
    func getLabel() {
        ...
        scoreLabel.text = "175M"
        messageLabel = self.childNodeWithName("Message") as! SKLabelNode
        messageLabel.text = "Survive for 175 meters"
    ...
    func levelComplete() {
        if levelsCompleted < 12 {
            NSUserDefaults.standardUserDefaults().setInteger(12, forKey: "LevelsCompleted")
            levelsCompleted = 12
        }
        //if currentLevel < 1 {
